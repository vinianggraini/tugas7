...
$result2 = mysqli_query($mysqli, "SELECT * FROM komentar where id");
?>
...
<table width="100%" border="0">    
        ...
        echo "<tr>";
       	...
       	echo "<td>&nbsp</td></tr>";
       	echo "<tr>";
       	echo "<td style='text-align: center;'><img src='img/peralatan.jpg' style='width: 45%; height: 450px;'></td></tr>";
       	echo "<tr>";
       	echo "<td style='text-align: center; font-size: 20px; font-family: Book Antiqua;'><p>Jangan lupa ya guys walau sesibuknya kita tetap menjaga kebersihan diri</p></td></tr>";
        echo "<tr>";
        echo "<td style='text-align: center; font-size: 20px; font-family: Book Antiqua;'><p>Karena kebersihan adalah sebagian dari iman</p></td></tr>";
	    }
	    ?>	 
</table>
