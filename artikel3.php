...
<table width="100%" border="0">    
        ...
        echo "<tr>";
       	...
       	echo "<td>&nbsp</td></tr>";
       	echo "<tr>";
       	echo "<td style='text-align: center;'><img src='img/memahami.jpg' style='width: 45%; height: 450px;'></td></tr>";
       	echo "<tr>";
       	echo "<td style='text-align: center; font-size: 20px; font-family: Book Antiqua;'><p>Menulis adalah suatu karya seni dalam ungkapan kata-kata indah</p></td></tr>";
	    }
	    ?>	 
</table>
